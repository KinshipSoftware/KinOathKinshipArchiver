 ...
 */
package nl.mpi.kinoath.graphsorter;
...
public class VersionTest extends TestCase {
    ...
    public void testGetArtifactVersion() {
        ...
        try {
            AbstractBaseModule abstractBasePlugin = new AbstractBaseModule("KinOathgGaphSorter", "Kinship Graph Sorter.", "nl.mpi.kinoath.graphsorter") {
            };
