...
public class VersionTest extends TestCase {
    ...
    public void testGetArtifactVersion() {
        ...
        try {
            AbstractBaseModule abstractBasePlugin = new AbstractBaseModule("KinOathBatik", "Kinship Batik diagram libaray.", "nl.mpi.kinoath.batik") {
            };
