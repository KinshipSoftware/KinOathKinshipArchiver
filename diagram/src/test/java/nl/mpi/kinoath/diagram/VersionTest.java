 ...
 */
package nl.mpi.kinoath.diagram;
...
public class VersionTest extends TestCase {
    ...
    public void testGetArtifactVersion() {
        ...
        try {
            AbstractBaseModule abstractBasePlugin = new AbstractBaseModule("KinOathDiagram", "Kinship diagram libaray.", "nl.mpi.kinoath.diagram") {
            };
