...
public class CsvImporter extends EntityImporter implements GenericImporter {
    ...
    private ArrayList<String> getFieldForLine(BufferedReader bufferedReader, char fieldSeparator) throws IOException {
    ...
    public URI[] importFile(InputStreamReader inputStreamReader) {
        ...
        try {
            ...
            ArrayList<String> allHeadings = getFieldForLine(bufferedReader, fieldSeparator);
...
//            String headingLine = bufferedReader.readLine();
            try {
                ...
                while (continueReading) {
                    ArrayList<String> lineFields = getFieldForLine(bufferedReader, fieldSeparator);
