...
//        kinTypeStringInput.setText(defaultString);
        ...
        graphPanel.setArbilTableModel(new MetadataPanel(graphPanel, entityCollection, tableHidePane, tableCellDragHandler, dataNodeLoader, null)); // todo: pass a ImageBoxRenderer here if you want thumbnails
