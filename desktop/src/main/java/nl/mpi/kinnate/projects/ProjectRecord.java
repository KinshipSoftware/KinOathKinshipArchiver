...
public class ProjectRecord {
    ...
    public File getFileInProject(UniqueIdentifier identifier) {
        return new File(new File(getProjectDataFilesDirectory(), identifier.getQueryIdentifier().substring(0, 3)), identifier.getQueryIdentifier() + ".kmdi");
    }
