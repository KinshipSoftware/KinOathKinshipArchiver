 ...
 */
package nl.mpi.kinoath.storage;
...
public class VersionTest extends TestCase {
    ...
    public void testGetArtifactVersion() {
        ...
        try {
            AbstractBaseModule abstractBasePlugin = new AbstractBaseModule("KinOathStorage", "Kinship Storage Libaray.", "nl.mpi.kinoath.storage") {
            };
