 ...
 */
package nl.mpi.kinoath.kintypesparser;
...
public class VersionTest extends TestCase {
    ...
    public void testGetArtifactVersion() {
        ...
        try {
            AbstractBaseModule abstractBasePlugin = new AbstractBaseModule("KinOathKinTypeStringParser", "Kin Type String Parser Module.", "nl.mpi.kinoath.kintypesparser") {
            };
