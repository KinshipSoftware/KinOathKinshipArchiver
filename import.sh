...
mvn install:install-file -Dfile=kinoath-testing.app/Contents/MacOS/lib/corpusstructure-api-1.8.1.jar -DgroupId=nl.nikhef -DartifactId=slcshttps -Dversion=0.2 -Dpackaging=jar -Dmaven.repo.local=$pwd;
