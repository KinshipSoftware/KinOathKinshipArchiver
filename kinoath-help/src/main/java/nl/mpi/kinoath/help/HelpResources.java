...
/**
 * Document : HelpResources <br> Created on Oct 2, 2012, 11:53 <br> 
 * based on ArbilHelpResources
 *
...
public class HelpResources extends AbstractBasePlugin {
    ...
    public final static String IMDI_HELP_INDEX_XML = HELP_RESOURCE_BASE + "index.xml";
